...
Function Test-List {
    ...
    $checksum = (Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/ParkHost/Script-for-Script/master/Check%20SCtask/templates/allow_tasks_checksum.txt').Content
